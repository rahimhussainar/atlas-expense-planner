...
const Footer: React.FC = () => {
  return (
    <footer className="w-full py-12 px-6 md:px-8 lg:px-12 bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-600 hover:text-gray-900 transition-colors">Testimonials</a></li>
